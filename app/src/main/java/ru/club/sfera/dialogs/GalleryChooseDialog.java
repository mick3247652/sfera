...
public class GalleryChooseDialog extends DialogFragment implements Constants {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (App.getInstance().getSettings().getAllowAddVideoToGallery() == ENABLED) arrayAdapter.add(getString(R.string.action_video_gallery));
