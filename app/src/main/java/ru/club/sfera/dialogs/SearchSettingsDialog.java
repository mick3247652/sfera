...
public class SearchSettingsDialog extends DialogFragment implements Constants {
    ...
    CheckBox genderMaleCheckBox, genderFemaleCheckBox, onlineCheckBox, verifiedCheckBox, photoCheckBox;

    private int searchGender, searchOnline, searchVerified, searchPhoto;
    ...
    OnClickListener positiveListener = new OnClickListener() {
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            alertPositiveListener.onCloseSettingsDialog(searchGender, searchOnline, searchVerified, searchPhoto);
        }
    };
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        searchVerified = bundle.getInt("searchVerified");
        ...
        LinearLayout view = (LinearLayout) getActivity().getLayoutInflater().inflate(R.layout.search_settings_dialog, null);
            ...
            public void onShow(DialogInterface dialog) {
                ...
                b.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        d.dismiss();
                        alertPositiveListener.onCloseSettingsDialog(getGender(), getOnline(), getVerified(), getPhoto());
                    }
                });
    ...
    public void setVerified(int verified) {
        ...
        if (verified == -1) {
            ...
            verifiedCheckBox.setChecked(false);
