...
public class CommentReportDialog extends DialogFragment implements Constants {
    ...
    public interface AlertPositiveListener {
        ...
        public void onCommentReport(long itemId, int reason);
    }
    ...
    OnClickListener positiveListener = new OnClickListener() {
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            alertPositiveListener.onCommentReport(itemId, reason);
        }
    };
