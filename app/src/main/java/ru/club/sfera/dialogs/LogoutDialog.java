...
public class LogoutDialog extends DialogFragment implements Constants {
    ...
    OnClickListener positiveListener = new OnClickListener() {
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            alertPositiveListener.onLogout();
        }
    };
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        b.setTitle(getText(R.string.action_logout));

        b.setMessage(getText(R.string.label_logout_msg));
