...
public class ItemChooseDialog extends DialogFragment implements Constants {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (App.getInstance().getSettings().getAllowAddVideoToItems() == ENABLED) arrayAdapter.add(getString(R.string.action_video_gallery));
