...
public class StreamFragment extends FragmentBase implements Constants, SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mRefreshButton = (Button)rootView.findViewById(R.id.refresh);
        ...
        mRecyclerView.addOnScrollListener(new OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if(pastVisiblesItems > 3) mRefreshButton.setVisibility(View.VISIBLE);
                else mRefreshButton.setVisibility(View.GONE);
    ...
    public void getItems() {
        ...
        CustomRequest jsonReq = new CustomRequest(Request.Method.POST, METHOD_ITEMS_STREAM, null,
