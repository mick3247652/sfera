...
public class PreviewGalleryListAdapter extends RecyclerView.Adapter<PreviewGalleryListAdapter.MyViewHolder> {
    ...
    public PreviewGalleryListAdapter(Context context, List<GalleryItem> images) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.preview_gallery_item, parent, false);
