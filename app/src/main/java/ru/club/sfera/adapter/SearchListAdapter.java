...
public class SearchListAdapter extends RecyclerView.Adapter<SearchListAdapter.MyViewHolder> {
	...
	public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        if (item.getDistance() == 0 && !item.isHasDistance()) {
            ...
            if (item.getDistance() == 0) {
                ...
                holder.mProfileUsername.setText("@" + item.getUsername() + " - " + mContext.getString(R.string.label_nearby));

            } else {

                holder.mProfileUsername.setText("@" + item.getUsername() + " - " + Double.toString(item.getDistance()) + "km");
            }
        }
