...
public class GalleryStreamFragment extends Fragment implements Constants, SwipeRefreshLayout.OnRefreshListener {
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        if (!isAdded() || getActivity() == null) {
                            ...
                            Log.e("ERROR", "GalleryStreamFragment Not Added to Activity");
    ...
    public void loadingComplete() {
        ...
        if (itemsAdapter.getItemCount() == 0) {
            ...
            if (GalleryStreamFragment.this.isVisible()) {
