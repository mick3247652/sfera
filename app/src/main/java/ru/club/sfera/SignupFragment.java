...
public class SignupFragment extends Fragment implements Constants {
    ...
    Button signupJoinHowBtn, mGender, facebookBtn;
    ...
    private int sex = 1, year = 2000, month = 1, day = 1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mGender.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                GenderChooseDialog alert = new GenderChooseDialog();

                alert.show(fm, "alert_dialog_gender_choose");
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (verifyRegForm()) {
                    ...
                    if (App.getInstance().isConnected()) {
                        ...
                        if (App.getInstance().getSettings().getAllowSignUp() == ENABLED) {
                            ...
                            Toast.makeText(getActivity(), R.string.msg_function_not_available, Toast.LENGTH_SHORT).show();
                        }
    ...
    public void updateView() {
        ...
        switch (sex) {
            ...
            default: {
                ...
                mGender.setText(getString(R.string.label_sex_undefined));
