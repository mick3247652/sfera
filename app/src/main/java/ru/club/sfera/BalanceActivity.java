...
import ru.club.sfera.util.IabHelper;
import ru.club.sfera.util.IabResult;
import ru.club.sfera.util.Inventory;
import ru.club.sfera.util.Purchase;
...
public class BalanceActivity extends ActivityBase {
    ...
    //static final String ITEM_SKU_1 = "networkpro.ifsoft.ru.iap1";          // Change to: yourdomain.com.iap1
    //static final String ITEM_SKU_2 = "networkpro.ifsoft.ru.iap2";          // Change to: yourdomain.com.iap2
    //static final String ITEM_SKU_3 = "networkpro.ifsoft.ru.iap3";          // Change to: yourdomain.com.iap3
    ...
    IabHelper.QueryInventoryFinishedListener mReceivedInventoryListener_4 = new IabHelper.QueryInventoryFinishedListener() {
        ...
        public void onQueryInventoryFinished(IabResult result, Inventory inventory) {
            ...
            if (result.isFailure()) {
                ...
                Log.e("Inventory", "Inventory Error");

            } else {

                Log.e("Inventory", "Inventory Async");

                //Purchase purchase = inventory.getPurchase(ITEM_SKU_4);
...
//                    try {
//
//                        String s = "{\"packageName\":\"ru.ifsoft.networkpro\",\"orderId\":\"transactionId.android.test.purchased\",\"productId\":\"android.test.purchased\",\"developerPayload\":\"ifsoft.inappbilling\",\"purchaseTime\":0,\"purchaseState\":0,\"purchaseToken\":\"inapp:ru.ifsoft.networkpro:android.test.purchased\"}";
//                        purchase = new Purchase("inapp", s, "");
//
