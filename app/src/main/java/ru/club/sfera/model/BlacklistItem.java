...
public class BlacklistItem extends Application implements Constants, Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeLong(this.blockedUserId);
        dest.writeInt(this.blockedUserState);
        dest.writeInt(this.createAt);
        dest.writeInt(this.blockedUserVerify);
        dest.writeString(this.blockedUserUsername);
        dest.writeString(this.blockedUserFullname);
        dest.writeString(this.blockedUserPhotoUrl);
    ...
    protected BlacklistItem(Parcel in) {
        this.id = in.readLong();
        this.blockedUserId = in.readLong();
        this.blockedUserState = in.readInt();
        this.createAt = in.readInt();
        this.blockedUserVerify = in.readInt();
        this.blockedUserUsername = in.readString();
        this.blockedUserFullname = in.readString();
        this.blockedUserPhotoUrl = in.readString();
        this.reason = in.readString();
        this.timeAgo = in.readString();
    }

    public static final Creator<BlacklistItem> CREATOR = new Creator<BlacklistItem>() {
        @Override
