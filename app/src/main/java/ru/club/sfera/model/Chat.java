...
public class Chat extends Application implements Constants, Parcelable {
    ...
    public Chat(JSONObject jsonData) {
        ...
        try {
            ...
            if (jsonData.has("android_fcm_regid")) {

                this.set_android_fcm_regId(jsonData.getString("android_fcm_regid"));
            }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.withUserVerified);
        dest.writeInt(this.withUserAllowShowOnline);
    ...
    protected Chat(Parcel in) {
        ...
        this.withUserVerified = in.readInt();
        this.withUserAllowShowOnline = in.readInt();
