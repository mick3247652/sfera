...
public class SearchFragment extends Fragment implements Constants, SwipeRefreshLayout.OnRefreshListener {
    ...
    private int search_gender = -1, search_online = -1, search_verified = -1, search_photo = -1, preload_gender = -1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            search_verified = savedInstanceState.getInt("search_verified");
            search_photo = savedInstanceState.getInt("search_photo");
        ...
        mHeaderSettings.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                b.putInt("searchVerified", search_verified);
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putInt("search_verified", search_verified);
        outState.putInt("search_phoot", search_photo);
    ...
    public void search() {
        ...
        CustomRequest jsonReq = new CustomRequest(Request.Method.POST, METHOD_SEARCH_PROFILE, null,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("verified", Integer.toString(search_verified));
        ...
        if (preload) {
            ...
            CustomRequest jsonReq = new CustomRequest(Request.Method.POST, METHOD_SEARCH_PROFILE_PRELOAD, null,
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    loadingComplete();
                    Log.e("Preload.error", error.toString());
                }
            }) {
